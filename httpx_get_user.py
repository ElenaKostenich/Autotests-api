...
get_user_headers = {
  "Authorization": f"Bearer {login_data["token"]['accessToken']}"
}
get_user_response = httpx.get(f"http://127.0.0.1:8000/api/v1/users/{create_user_data["user"]['id']}", headers=get_user_headers)
